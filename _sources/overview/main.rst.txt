...
s3Verify              INT      OPTIONAL. If set to 0 will disable SSL verification when writing/reading to bucket. Default is 1.
s3Certificates        INT      OPTIONAL. Path to SSL certificates, only needed if custom certificates are used.
