...
DEFAULT_FIELD_COLORMAP = {
    # field name : colormap
    reflectivity: "NWSRef",
    normalized_reflectivity: "NWSRef",
    linear_reflectivity: "NWSRef",
    corrected_reflectivity: "NWSRef",
    total_power: "NWSRef",
    unfiltered_reflectivity: "NWSRef",
    corrected_unfiltered_reflectivity: "NWSRef",
    reflectivity_vv: "NWSRef",
    corrected_reflectivity_vv: "NWSRef",
    unfiltered_reflectivity_vv: "NWSRef",
    reflectivity_bias: "NWSRef",
    signal_power_hh: "NWSRef",
    signal_power_vv: "NWSRef",
    volumetric_reflectivity: "NWSRef",
    volumetric_reflectivity_vv: "NWSRef",
    bird_density: "NWSRef",
    bird_reflectivity: "NWSRef",
    radar_cross_section_hh: "NWSRef",
    radar_cross_section_vv: "NWSRef",
    spectral_reflectivity_hh: "NWSRef",
    spectral_reflectivity_vv: "NWSRef",
    unfiltered_spectral_reflectivity_hh: "NWSRef",
    unfiltered_spectral_reflectivity_vv: "NWSRef",
    avg_reflectivity: "NWSRef",
    quant05_reflectivity: "NWSRef",
    quant10_reflectivity: "NWSRef",
    quant20_reflectivity: "NWSRef",
    quant50_reflectivity: "NWSRef",
    quant80_reflectivity: "NWSRef",
    quant90_reflectivity: "NWSRef",
    quant95_reflectivity: "NWSRef",
    noisedBm_hh: "NWSRef",
    noisedBm_vv: "NWSRef",
    noisedBZ_hh: "NWSRef",
    noisedBZ_vv: "NWSRef",
    noisedBADU_hh: "NWSRef",
    noisedBADU_vv: "NWSRef",
    noiseADU_hh: "NWSRef",
    noiseADU_vv: "NWSRef",
    ...
    sigma_zh: "NWSRef",
    stat_test_lag1: "NWSRef",
    stat_test_lag2: "NWSRef",
    wide_band_noise: "NWSRef",
    fields_difference: "BuDRd18",
    field_mask: "Greys_r",
    field_texture: "Greys_r",
    sun_hit_power_h: "NWSRef",
    sun_hit_power_v: "NWSRef",
    sun_hit_differential_reflectivity: "RefDiff",
    sun_est_power_h: "NWSRef",
    sun_est_power_v: "NWSRef",
    ...
    vpr_correction: "BuDRd18",
    adjustment_factor: "BuDRd18",
    ...
    corrected_unfiltered_differential_reflectivity: "RefDiff",
    ...
    theoretical_cross_correlation_ratio: "RefDiff",
    ...
    radar_rainrate_relation: "LangRainbow12",
    precipitation_type: "LangRainbow12",
    radar_echo_classification: "LangRainbow12",
    corrected_radar_echo_classification: "LangRainbow12",
    radar_echo_classification_MF: "LangRainbow12",
    hydroclass_entropy: "LangRainbow12",
    hydroclass_confidence: "LangRainbow12",
    ...
    probability_AG: "LangRainbow12",
    probability_CR: "LangRainbow12",
    probability_LR: "LangRainbow12",
    probability_RP: "LangRainbow12",
    probability_RN: "LangRainbow12",
    probability_VI: "LangRainbow12",
    probability_WS: "LangRainbow12",
    probability_MH: "LangRainbow12",
    probability_IH: "LangRainbow12",
    vol2bird_echo_classification: "LangRainbow12",
    radar_echo_id: "LangRainbow12",
    clutter_exit_code: "LangRainbow12",
    melting_layer: "LangRainbow12",
    height_over_iso0: "BuDRd18",
    corrected_height_over_iso0: "BuDRd18",
    ...
    corrected_doppler_spectrum_width: "NWS_SPW",
    # doppler_spectrum_mean_error:
    atmospherical_structures_type: "LangRainbow12",
    relative_beta: "NWSRef",
    absolute_beta: "NWSRef",
    cnr: "Carbone17",
    corrected_cnr: "Carbone17",
    ...
    "DBZ_S": "NWSRef",
    "DBZ_K": "NWSRef",
    "reflectivity_horizontal": "NWSRef",
    "corr_reflectivity": "NWSRef",
}
...
DEFAULT_FIELD_LIMITS = {
    # field name : limits
    # reflectivity: (-30., 75.),
    reflectivity: (-10.0, 70.0),
    normalized_reflectivity: (-6.0, 6.0),
    linear_reflectivity: (0.0, 1e7),
    avg_reflectivity: (-10.0, 70.0),
    quant05_reflectivity: (-10.0, 70.0),
    quant10_reflectivity: (-10.0, 70.0),
    quant20_reflectivity: (-10.0, 70.0),
    quant50_reflectivity: (-10.0, 70.0),
    quant80_reflectivity: (-10.0, 70.0),
    quant90_reflectivity: (-10.0, 70.0),
    quant95_reflectivity: (-10.0, 70.0),
    bird_reflectivity: (-10.0, 70.0),
    corrected_reflectivity: (-10.0, 70.0),
    total_power: (-10.0, 70.0),
    # unfiltered_reflectivity: (-30., 75.),
    unfiltered_reflectivity: (-10.0, 70.0),
    corrected_unfiltered_reflectivity: (-10.0, 70.0),
    # reflectivity_vv: (-30., 75.),
    reflectivity_vv: (-10.0, 70.0),
    corrected_reflectivity_vv: (-10.0, 70.0),
    # unfiltered_reflectivity_vv: (-30., 75.),
    unfiltered_reflectivity_vv: (-10.0, 70.0),
    ...
    differential_reflectivity: (-10.0, 10.0),
    corrected_differential_reflectivity: (-1.0, 2.0),
    # unfiltered_differential_reflectivity: (-1., 8.),
    unfiltered_differential_reflectivity: (-10.0, 10.0),
    corrected_unfiltered_differential_reflectivity: (-10.0, 10.0),
    ...
    theoretical_cross_correlation_ratio: (0.8, 1.0),
    ...
    rain_rate: (0.0, 10.0),
    radar_estimated_rain_rate: (0.0, 10.0),
    rainfall_accumulation: (0.0, 100.0),
    precipitation_type: (0.0, 20.0),
    ...
    vol2bird_background: (0.0, 1.0),
    vol2bird_weather: (0.0, 1.0),
    vol2bird_biology: (0.0, 1.0),
    ...
    corrected_height_over_iso0: (-6000.0, 6000.0),
    iso0_height: (0.0, 5000.0),
    corrected_iso0_height: (0.0, 5000.0),
    # Additional reflectivity like fields
    "CZ": (-10.0, 65.0),
    "DZ": (-10.0, 65.0),
    "AZ": (-10.0, 65.0),
