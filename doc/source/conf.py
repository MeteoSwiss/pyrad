...
version = re.sub(r"^(\d+\.\d+)\.\d+(.*)", r"\1\2", pyrad.version.version)
if "dev" in version:
...
release = pyrad.version.version
# full pyrad version in CI built docs
...
#
html_theme_options = {
    "github_url": "https://github.com/MeteoSwiss/pyrad",
}
...
html_sidebars = {
    ...
    "overview/*": ["searchbox.html", "sidebar-nav-bs.html"],
}
