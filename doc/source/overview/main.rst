...
.. admonition:: **Note on s3 and MySQL writing**
  ...
  The optional argument *MySQLdrop* can be set to True in the main configuration file to drop the MySQL table before writing new data to it.  If *MySQLdrop* is False (default), new data will be appended to the existing table.
