...
description
	Reads data from the ICON model, previously ingested by pyrad and converted to polar coordinates with the `ICON_LOOKUP dataset <https://meteoswiss.github.io/pyrad/_modules/pyrad/proc/process_icon.html#process_icon_lookup_table>`_.
	For this to work you will need to define the variable *iconpath* in the main pyrad configuration file.
 

usage
	*ICON:datatype* where datatype is a pyrad variable name as listed `here <https://meteoswiss.github.io/pyrad/overview/list_variables.html#icon-to-pyrad>`_.
example
...
usage
	*CFRADIALICON:datatype,dataset*
	where 	    
	    - datatype is a pyrad variable name as listed `here <https://meteoswiss.github.io/pyrad/overview/list_variables.html#icon-to-pyrad>`_
